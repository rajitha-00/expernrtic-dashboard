...
const FileView = (props) => {
  return (
    <>
      <div className="rowWhite mt-5 hover:shadow-md  bg-white py-2 rounded-[10px] lg:mx-10 px-7 flex justify-between w-[97%] items-center">
        <div className="flex items-center justify-between ">
            <div className="file ">
                <img src="./pdf.png" alt="pdf" />
            </div>
            <div className="fileName">
                <p className='sm:text-xs md:font-semibold px-5'>{props.fileName}</p>
            </div>
        </div>
        <div className="date">
            <p className='bg-gray-200 sm:text-xs  py-1 px-5 rounded-[10px]'>{props.date}</p>
        </div>
        <div className="flex">
